...
TEST_F(KvClusterTest, DISABLED_TestOneFollowerFailPutAndGetForSevenServers) {
  auto cluster_config = KvClusterConfig{
      ...
      {2, {2, {"127.0.0.1", 50002}, {"127.0.0.1", 50012}, "/mnt/ssd1/log2", "./testdb2"}},
      {3, {3, {"127.0.0.1", 50003}, {"127.0.0.1", 50013}, "/mnt/ssd1/log3", "./testdb3"}},
      {4, {4, {"127.0.0.1", 50004}, {"127.0.0.1", 50014}, "/mnt/ssd1/log4", "./testdb4"}},
      {5, {5, {"127.0.0.1", 50005}, {"127.0.0.1", 50015}, "/mnt/ssd1/log5", "./testdb5"}},
      {6, {6, {"127.0.0.1", 50006}, {"127.0.0.1", 50016}, "/mnt/ssd1/log6", "./testdb6"}},
  };
  LaunchKvServiceNodes(cluster_config);
  Disconnect(rand() % node_num_);
  sleepMs(1000);
